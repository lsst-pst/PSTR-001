...
cadence.
  ...
  Availability of simulations for baseline survey v3.0\\
\strut \\
...
& {\small Lynne Jones } & {\small Leanne Guy } &
\begin{minipage}[]{6cm}
\smallskip
{\small  }
\medskip
...
github.com/lsst-pst/PSTR-001/notebooks/SkyCoverage.ipynb
...
\end{tabular}
 Description \\
{\footnotesize
Confirm Asky \textgreater{} 15000 sq degrees.\\
Confirm Visits \textgreater{} 750.\\
\strut \\
...
\end{tabular}
 Description \\
{\footnotesize
Run notebook at GitHub.com/lsst-pst/PSTR-001/notebooks/SkyCoverage.ipynb
...
\end{tabular}
 Description \\
{\footnotesize
Confirm Area Rapid revisit is \textgreater2000 sq deg.
...
{\footnotesize
Run notebook at
GitHub.com/lsst-pst/PSTR-001/notebooks/Parallax\_ProperMotion.ipynb
...
\end{tabular}
 Description \\
{\footnotesize
Confirm SIGpm meets requirements (1.0mas design, 2.0mas minimum)
...
(github.com/lsst-pst/PSTR-001/notebooks/Time\_Between\_Visits.ipynb)
...
\end{tabular}
 Description \\
{\footnotesize
Confirm aveTimeInterval \textless{} 10s\\
\strut \\
...
\end{tabular}
 Description \\
{\footnotesize
Confirm medianVisitInterval \textless{} 5s
...
\end{tabular}
 Description \\
{\footnotesize
Confirm SIGpar and SIGparRed meet requirements.
